...
// TEST BATCH VERIFICATION    
	...
	PolyCommitment com3(&p, f3);
    G1 C3 = com3.get_C();
    cout << C3;
	ZZ_pX f4 = random_ZZ_pX(deg+1);
	PolyCommitment com4(&p, f4);
    G1 C4 = com4.get_C();
    cout << C4;
    vector<PolyCommitment> polys;
    ...
    ZZ_p fi3 = eval(f3, i);
    ZZ_p fi4 = eval(f4, i);
    vector<G1> w34 = PolyCommitment::createwitness(polys, i);
